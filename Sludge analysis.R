# Analysis of sewage sludge chemical characteristics
...
# Micronutrients and benefical elements
...
# Correlation matrix
mcor <- cor(data[,3:16], method = "pearson"); mcor
pmat <- cor_pmat(data[,3:16], method="pearson"); pmat
